...
export default function TableOrderPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      ...
      {/* Existing Order Context Banner */}
      {!isTrackingOrder && placedOrder && (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-blue-900">Adding to Existing Order</h3>
                <p className="text-sm text-blue-700">
                  Items will be added to Order #{placedOrder.orderNumber} • Same bill, more items!
                </p>
              </div>
            </div>
          </div>
